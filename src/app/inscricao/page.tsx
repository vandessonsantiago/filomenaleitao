        ...
        <section className="max-w-5xl m-auto">
          <div className="flex flex-col items-center gap-3 ">
            <div className="bg-white w-[640px] min-h-[420px] mt-8 rounded-xl border-t-8 border-[1px] border-gray-400 px-8 py-4">
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-[0.9rem]">
                  ...
                  intitulada “Depressão. Afinal como intervir na prática? O que
                  não vem nos livros", com duração de 16 horas. Será a minha
                  primeira edição e espero poder reproduzi-la muitas outras
                  vezes.
                </p>
                <p className="text-[0.9rem]">
                  <span className="font-semibold">NOTA:</span> Os encontros são
                  realizados online através de Zoom. Irá receber no email o link
                  e os dados para participar em cada encontro. Os encontros não
                  são aulas, são espaços de partilha entre os/as participantes
                  e, por isso, as sessões não são gravadas e as câmeras estarão
                  ligadas.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white w-[640px] rounded-2xl px-8 py-4 border-[1px] border-gray-400">
              ...
              <div className="flex flex-col my-4">
                <p className="pb-2 text-xs font-semibold">
                  Indica o seu número profissional - OPP.
                </p>
                <input
                  {...register("opp", {
                    required: true,
            ...
            <div className="bg-white w-[640px] rounded-2xl px-8 py-4 border-[1px] border-gray-400">
              ...
              <p className="text-[0.9rem] pt-2">
                ...
                mediante a sua solicitação em até 72h antes da realização da
                formação.
              </p>
              <p className="text-[0.9rem] pt-2">
